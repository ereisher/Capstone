...
cd /common/claytonlab/ereisher/capstone/browse_1-2/qiime2/picrust/vis-lefse

# Get the path_abun_unstrat.tsv file
cp /common/claytonlab/ereisher/capstone/browse_1-2/qiime2/picrust/results/pathways_out/path_abun_unstrat.tsv.gz /common/claytonlab/ereisher/capstone/browse_1-2/qiime2/picrust/vis-lefse/
...
python run_lefse.py /common/claytonlab/ereisher/capstone/browse_1-2/qiime2/picrust/vis-lefse/path_abun_modified.in path_abun_modified.res
